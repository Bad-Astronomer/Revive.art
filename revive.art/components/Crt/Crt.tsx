...
export default function Crt() {
    ...
    const color = useTransform(scrollYProgress, [start_keyframe, end_keyframe], ["saturate(0.2)", "saturate(0.8)"], { ease: easeIn });
    ...
    return (
        <div className={"relative h-[200vh] isolate"} ref={crtContainerRef}>
            ...
            <motion.div
                ...
                style={{ background: "linear-gradient(to bottom, transparent 0%, #0f0f0f 100%)", opacity }}
            ></motion.div>
            </div>
        </div>
    )
