...
export default function Crt() {
    ...
    const height = useTransform(scrollYProgress, [start_keyframe, mid_keyframe], ["370px", `${windowSize[1]}px`], { ease: easeIn });
    const color = useTransform(scrollYProgress, [start_keyframe, end_keyframe], ["saturate(0) contast(0.75)", "saturate(1.1) contrast(1.5)"], { ease: easeIn });
    ...
    return (
        <div className={"relative h-[250vh] isolate"} ref={crtContainerRef}>
            ...
            <motion.div
                ...
                style={{ background: "linear-gradient(to bottom, transparent 50%, #0f0f0f 100%)", opacity }}
            ></motion.div>
            </div>
        </div>
    )
